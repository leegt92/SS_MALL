		...
		<div id="content">			 
			<table class="table table-list-search ">
				<form action="modify" method="post">
					...
					<%-- <tr>
						 <th class="qs-title"style=" marjin:top 100px; color:black;"  >${content_view.bTitle}>  <img src="https://ssl.nx.com/s2/game/maplestory/renewal/common/notice_icon01.png" alt="[공지]"></th>

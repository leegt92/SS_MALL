...
.bg-light {
  ...
  <body>
    ...
    <ul class="accordion1" style="height: 220px;">
        ...
        <li class="accordion2">
            <h3 style="font-size:16px; class="accordion3"><c:out value = "${askRequestboards.btitle}"/><c:out value = " (${askRequestboards.bdate})"/></h3>
            <div class="accordion3">
              <c:out value = "${askRequestboardsAnswers[status.index].btitle}"/>
              <c:out value = "${askRequestboardsAnswers[status.index].bcontent}"/>
            </div>
        </li>
        </c:forEach>
        <button onclick="window.location.href='/ssmall'" style="margin-top: 50px; margin-left: 530px;"><font size="5em" style="border:2px solid black; background-color:#bebebe">1:1문의 글쓰기</font></button>
    </ul>
</div>

	...
	<div class="wrapper">
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a 
					href="/ssmall/admin/asList" class="nav-link">A/S</a></li>
			</ul>					
		</nav>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">							
						...
						<li class="nav-item has-treeview">
							<div class="dropdown">
								<a href="/ssmall/admin/asList"><button class="dropbtn" style="font-weight: bold;">A/S요청</button></a>
								<div class="dropdown-content">
										...
										<c:forEach items="${aSRequestboards}" var="aSRequestboards">
											<tr>
												...
												<td style="text-align: center; vertical-align: middle;"><a
													href="/ssmall/admin/requestWrite?bId=${aSRequestboards.bid}">${aSRequestboards.btitle}</a></td>
										...
										<ul class="pagination m-5 flex-c-m">
											<c:if test="${pageMaker.prev}">
												...
												<li class="page-item"><a class="page-link"
													aria-label="Previous"
													href="/ssmall/admin/unAnsweredasList${pageMaker.makeQuery(pageMaker.startPage - 1)}">«</a></li>
											...
											<c:forEach begin="${pageMaker.startPage }"
												...
												<li class="page-item"><a class="page-link"
													href="/ssmall/admin/unAnsweredasList${pageMaker.makeQuery(idx)}">${idx}</a></li>
											</c:forEach>

											<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
												<li class="page-item"><a class="page-link"
													href="/ssmall/admin/unAnsweredasList${pageMaker.makeQuery(pageMaker.endPage +1) }">»</a></li>
											</c:if>
										</ul>
									</nav>
									<br>

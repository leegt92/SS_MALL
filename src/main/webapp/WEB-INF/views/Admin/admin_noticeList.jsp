											...
											<ul class="pagination m-5 flex-c-m">
												<c:if test="${pageMaker.prev}">
													...
													<li class="page-item"><a class="page-link"
														aria-label="Previous"
														href="/ssmall/admin/noticeList${pageMaker.makeQuery(pageMaker.startPage - 1)}">«</a></li>
												...
												<c:forEach begin="${pageMaker.startPage }"
													...
													<li class="page-item"><a class="page-link"
														href="/ssmall/admin/noticeList${pageMaker.makeQuery(idx)}">${idx}</a></li>
												</c:forEach>
			
												<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
													<li class="page-item"><a class="page-link"
														href="/ssmall/admin/noticeList${pageMaker.makeQuery(pageMaker.endPage +1) }">»</a></li>
												</c:if>
											</ul>
										</nav>
									</div>

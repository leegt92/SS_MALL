...
.bg-light {
 ...
 ul li {
  ...
  <body>
			...
			<div class="flex-w flex-tr">
				...
				">
					...
					<form id="submitAskRequest" action="/ssmall/mypage/myPage_askRequest_back">
						...
						<button id = "AskRequestButton" type="button" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
							제출
						</button>
					</form>
				</div>
   ...
   <script>	
  	$("#AskRequestButton").click(function(event) {

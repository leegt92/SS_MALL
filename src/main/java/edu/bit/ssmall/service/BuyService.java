...
public class BuyService {
	...
	public void buy(String m_number, String p_number, String amount, String totalprice, String imp_uid, String b_memo,
		...
		//포인트 적립
		plusPoint(m_number, p_number, amount);
	
	}
	
	//회원 포인트 적립
	public void plusPoint(String m_number, String p_number, String amount) {
		...
		int point = (int) (productImageVO.getP_price() * 0.01 * Integer.parseInt(amount));			

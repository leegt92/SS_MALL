...
public class CardVO {
    ...
    private String kakaopay_purchase_corp; //카카오페이 매입자명
    private String kakaopay_purchase_corp_code; //카카오페이 매입자코드
    private String kakaopay_issuer_corp; //카카오페이 발급자명
    private String kakaopay_purchase_code; //카카오페이 발급자코드
    ...
    private String card_item_code; //카드상품코드
	...
	public String getKakaopay_purchase_code() {
		return kakaopay_purchase_code;
	}
	public void setKakaopay_purchase_code(String kakaopay_purchase_code) {
		this.kakaopay_purchase_code = kakaopay_purchase_code;
	}
	...
	public String toString() {
		return "CardVO [purchase_corp=" + purchase_corp + ", purchase_corp_code=" + purchase_corp_code
				...
				+ ", kakaopay_purchase_code=" + kakaopay_purchase_code + ", bin=" + bin + ", card_type=" + card_type
				+ ", install_month=" + install_month + ", approved_id=" + approved_id + ", card_mid=" + card_mid
				+ ", interest_free_install=" + interest_free_install + ", card_item_code=" + card_item_code + "]";
	}
